namespace Drones
{
    partial class FormAvgDistance
    {
        ...
        private void InitializeComponent()
        {
			...
			// Column3
			// 
			this.Column3.HeaderText = "Дистанція";
			...
			this.label1.Text = "Середній результат дистанція";
			// 
			// textBox1
			// 
			...
			// buttonClose
			// 
			this.buttonClose.Location = new System.Drawing.Point(179, 249);
			...
			this.Name = "FormAvgDistance";
			this.Text = "Середня дистанція";
